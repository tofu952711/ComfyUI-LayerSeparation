...
- **前景元素** — BiRefNet/u2net 抠出的商品/元素 (IMAGE batch)
...
| birefnet / u2net / isnet | ~176M–972M | rembg | `$U2NET_HOME` (默认 `~/.u2net/`) |
...
python download_models.py u2net           # 或指定其它抠图模型
```
...
| 抠图模型 | 选择 | birefnet-general | birefnet-general(质量最好) / birefnet-massive / isnet-general-use / u2net / u2netp |
